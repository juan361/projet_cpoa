...
public class EquipeRamasseurDAO {
   ...
   public java.util.Collection<RamasseurDAO> ramasseur;
   
   
   /** @pdGenerated default getter */
   public java.util.Collection<RamasseurDAO> getRamasseur() {
      if (ramasseur == null)
         ramasseur = new java.util.HashSet<RamasseurDAO>();
      return ramasseur;
   }
   ...
   /** @pdGenerated default setter
     * @param newRamasseur */
   public void setRamasseur(java.util.Collection<RamasseurDAO> newRamasseur) {
      removeAllRamasseur();
      for (java.util.Iterator iter = newRamasseur.iterator(); iter.hasNext();)
         addRamasseur((RamasseurDAO)iter.next());
   }
   
   /** @pdGenerated default add
     * @param newRamasseur */
   public void addRamasseur(RamasseurDAO newRamasseur) {
      if (newRamasseur == null)
         return;
      if (this.ramasseur == null)
         this.ramasseur = new java.util.HashSet<RamasseurDAO>();
   ...
   /** @pdGenerated default remove
     * @param oldRamasseur */
   public void removeRamasseur(RamasseurDAO oldRamasseur) {
